...
username.send_keys('_ka.vita')
password = webdriver.find_element_by_name('password')
password.send_keys('Rabbids254')
...
notnow.click()
notification = webdriver.find_element_by_css_selector('body > div.RnEpo.Yx5HN > div > div > div > div.mt3GC > button.aOOlW.HoLwm')
notification.click()

hashtag_list = ['pythonprogramming', 'pythoncode', 'pythonprogrammer',]
prev_user_list = []
new_followed = []
tag = -1
followed = 0
        ...
        for x in range(1, 200):
            ...
            if username not in prev_user_list:
                ...
                if webdriver.find_element_by_xpath('/html/body/div[4]/div[2]/div/article/header/div[2]/div[1]/div[2]/button').text == 'Follow':
                    ...
                    webdriver.find_element_by_link_text('Next').click()
                    sleep(randint(20, 26))
    # some hashtags may stop refreshing photos, and therefore it continues to the next
    except:
        continue
